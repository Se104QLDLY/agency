    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
        <div className="w-full flex flex-col gap-8">
          ...
          {/* Main Content */}
          {/* Form Section */}
          <div className="bg-white rounded-3xl shadow-xl border-2 border-blue-100 w-full overflow-hidden p-0">
          ...
          {/* Requests History */}
          {/* Lịch sử đơn hàng */}
          <div className="bg-white rounded-3xl border w-full overflow-hidden p-0">
            <div className="bg-gradient-to-r from-pink-600 to-purple-500 px-6 py-4 rounded-t-3xl">
              <div className="flex items-center gap-3">
                <Clock className="h-6 w-6 text-white" />
                <h3 className="text-xl font-bold text-white">Lịch sử đơn hàng</h3>
                <span className="ml-2 text-sm text-pink-100">{requests.length} yêu cầu</span>
              </div>
            </div>
          ...
          <div className="mt-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8 border border-blue-200 w-full">
