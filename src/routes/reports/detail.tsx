        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-red-50">
            <tr>
              ...
              <th className="px-6 py-3 text-right text-xs font-medium text-red-700 uppercase tracking-wider">Nợ đầu kỳ</th>
              ...
              <th className="px-6 py-3 text-right text-xs font-medium text-red-700 uppercase tracking-wider">Nợ cuối kỳ</th>
            </tr>
          </thead>
          <tbody className="bg-white divide-y divide-gray-200">
            {debtData.map((item, index) => (
              <tr key={index} className="hover:bg-red-50">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-blue-900">DL{item.agency_id}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.agency_name}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-900">{formatCurrency(item.debt_beginning)}</td>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right font-semibold text-red-700">{formatCurrency(item.debt_ending)}</td>
              </tr>
            ))}
          </tbody>
          <tfoot className="bg-red-100">
            <tr>
              ...
              <td className="px-6 py-4 text-sm text-right font-bold text-red-800">
                {formatCurrency(debtData.reduce((sum, item) => sum + item.debt_beginning, 0))}
              </td>
              <td className="px-6 py-4 text-sm text-right font-bold text-red-800">
              ...
              <td className="px-6 py-4 text-sm text-right font-bold text-red-800">
                {formatCurrency(debtData.reduce((sum, item) => sum + item.debt_ending, 0))}
              </td>
            </tr>
          </tfoot>
        </table>
